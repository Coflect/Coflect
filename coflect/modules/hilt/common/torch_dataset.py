"""Torch dataset builders for HILT training and XAI regeneration."""
...
from coflect.modules.hilt.common.synth_dataset import DeterministicSyntheticImages
...
def build_torch_dataset(cfg: DatasetConfig) -> Dataset:
    """Construct a HILT dataset compatible with trainer and XAI worker."""
